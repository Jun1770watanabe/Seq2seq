...
class Seq2seq(chainer.Chain):
    ...
    def __init__(self, n_layers, source_vocab, target_vocab, n_units):
        n_source_vocab = len(source_vocab)
    ...
    def translate(self, xs, max_length=100):
        ...
        outs = []
        for y in result:
            inds = numpy.argwhere(y == EOS) # EOS = '1'
            if len(inds) > 0:
                y = y[:inds[0, 0]]
            outs.append(y)
        return outs
    ...
    def __call__(self, trainer):
        ...
        with chainer.no_backprop_mode():
            ...
            for i in range(0, len(self.test_data), self.batch):
                ...
                print(">> start translate in CalcBLEU <<")
                ys = [y.tolist()
...
def main():
    ...
    # Setup model
    model = Seq2seq(args.layer, source_ids, target_ids, args.unit)
